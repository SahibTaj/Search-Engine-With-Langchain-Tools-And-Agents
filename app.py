...
st.title("🔎 AI Search Engine (LangChain Agent + Groq)")
"""
In this example, we're using 'StreamlitCallbackHandler' to stream responses from a Groq model in a Streamlit app.
